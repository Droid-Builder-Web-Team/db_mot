...
(function () {
    ...
    var collect = function (dom, rootNode, startNode, endNode, callbacks, skipStart) {
        ...
        walk(
            dom, walker.next.bind(walker), startNode, {
    ...
    var collectRangeSections = function (dom, rng) {
        ...
        return collect(
            dom, rng.commonAncestorContainer, startNode, endNode, {
                ...
                cef: function (node) {
                    var sections = bind(
                        descendants(SugarElement.fromDom(node), '*[contenteditable=true]'), function (e) {
                            var ceTrueNode = e.dom;
                            return collect(dom, ceTrueNode, ceTrueNode);
                        }
                    );
                    return sort(
                        sections, function (a, b) {
    ...
    var extract = function (elements, matches) {
        var nodePositions = foldl(
            elements, function (acc, element) {
                var content = get(element);
                var start = acc.last;
                var finish = start + content.length;
                var positions = bind(
                    matches, function (match, matchIdx) {
        ...
        return groupBy(
            nodePositions, function (position) {
