    ...
    <div class="build-section">
        <div class="container-fluid">
            <div class="row build-section">
                ...
                <div class="col-12 db-mt-2 d-block d-lg-flex justify-content-between">
                    ...
                    <div class="user-stats-box">
                        ...
                        <div class="user-stat">
                            <div class="text-value text-info">{{ $user->droids->count() }}</div>
                    ...
                    <div class="user-stats-box">
                        ...
                        <div class="user-stat">
                            @if ($user->join_date != '')
                            <div class="text-value text-info">{{ $user->yearsService() }}</div>
                            @else
                    ...
                    <div class="user-stats-box">
                        ...
                        <div class="user-stat">
                            <div class="text-value text-info">{{ $user->achievements->count() }}</div>
            ...
            {{-- Achievements --}}
            <div class="row build-section db-mb-2 achievements">
                <div class="col-12">
            ...
            {{-- Events To Finish --}}
            <div class="row build-section text-center db-mb-2 events">
                <div class="col-12 text-center">
            ...
            <div class="row build-section text-center db-mb-2 course-runs">
                <div class="col-12">
