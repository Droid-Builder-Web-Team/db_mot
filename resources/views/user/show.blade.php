...
@section('content')
    ...
    <div class="build-section db-mt-2">
        <div class="container-fluid">
            <div class="row">
                <h4 class="text-uppercase db-mb-1 d-flex align-items-center justify-content-center">Your Droids</h4>
            </div>
    ...
    <div class="build-section db-mt-2">
        <div class="container-fluid">
            <div class="row">
                <h4 class="text-uppercase db-mb-1 d-flex align-items-center justify-content-center">Achievements</h4>
            </div>
    ...
    <div class="build-section db-mt-2">
        <div class="container-fluid">
            <div class="row">
                <h4 class="text-uppercase db-mb-1 d-flex align-items-center justify-content-center">Driving Course Runs</h4>
            </div>
