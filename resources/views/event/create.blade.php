    ...
    <div class="card">
            ...
            <div class="row d-flex ">
                <div class="text-left col-3">
                    <a class="btn btn-mot-invert" style="width:auto; color:white;"
                        href="{{ route('event.index') }}">{{ __('Back') }}</a>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-sm-12">
                    <p>
                        This form is to allow members to submit events that they have heard about and are interested in
                        going. A member of the admin team will then approve it. Please enter
                        as much detail as you can, and make sure the address is correct.
                    </p>
                    <p>
                        Also, please check that the location doesn't already exist using the drop down. This will allow us
                        to rate and comment about
            ...
            <div class="form-group row d-flex justify-content-center align-items-center">
                ...
                <div class="col-sm-5">
                    <select class="form-control location-dropdown @error('location_id') is-invalid @enderror"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="location_name"
                                class="form-control @error('location_name') is-invalid @enderror" placeholder="Name"
            ...
            <div class="form-group row d-flex justify-content-center align-items-center">
                ...
                <div class="col-sm-10">
                    <input type="text" name="parking_details" id="parking_details" class="form-control"
                        placeholder="Event Parking Details" value={{ old('parking_details') }}>
                </div>
            </div>
            ...
            <div class="form-group row d-flex justify-content-center align-items-center">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check">
                        {!! html()->hidden('wip_allowed', '0') !!}
                        <input type="checkbox" id="wip_allowed" name="wip_allowed" class="form-check-input" value="1">
                        <label class="form-check-label" for="wip_allowed">{{ __('WIP Droids Allowed') }}</label>
                    </div>
                </div>
            </div>
