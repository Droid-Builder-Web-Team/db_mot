...
<div class="row">
    <div class="card">
        <div class="card-header">
            <h4 class="title text-center">Parts Run Info</h4>
        </div>
        <div class="card-body">
            <p>Part Runs are talked about a lot in the Droid Building Community and we felt it was a good idea to list some of the regular questions
                ...
                <ol>
                    <li class="mb-4"><strong>What are parts runs?</strong>
                        <ul>
                            <p class="mb-3">A parts run is run via Astromech.net and allows people to purchase parts for their Astromech droid.</p>
                        </ul>
                    </li>
                    <li class="mb-4"><strong>Why do we have them?</strong>
                        <ul>
                            <p class="mb-3">Without parts runs all parts would be scratch built, or 3D printed and assembled.  While this is valid for some parts others such as the lights would be problematic to build one off electronics all the time, so is easier to do a run of 10 kits then sell to builders who need them.  Also economies of scale allow the price to be reduced as more kits are made.</p>
                        </ul>
                    </li>
                    <li class="mb-4"><strong>What is BC Approved?</strong>
                        <ul>
                            <p class="mb-3">When a part is BC approved it means it will fit with any other BC approved part, or require minimum effort for them to fit.  A small caveat is there is the legacy CSL spec and newer CSR spec so buyers need to make sure they purchase the right parts as some CSR and CSL parts are not interchangeable.</p>
                            <p class="mb-3">When BC parts are purchased via the forum it is audited and allows us to see when people signed up.  Then once the parts have been produced the payment can be made and the parts shipped.  This is important as the seller has the initial outlay of the costs, then the parts ship when available rather than taking money up front and then shipping months later. </p>
                        </ul>
                    </li>
                    <li class="mb-4"><strong>What is the difference between buying a BC Approved Part VS buying from a Facebook Group or eBay?</strong>
                        <ul>
                            <p class="mb-3">Buying part via the forum means you are getting good parts, even via the junkyard section.  On Facebook or eBay you have no idea what you are purchasing, the parts may seem cheap, but they are cheap for a reason as they are potentially badly made, made from cheap materials and made for profit rather than being made to build a decent droid.
                                You can always read the horror stories on Astromech.net if you have any doubt.
                            </p>
                        </ul>
                    </li>
                    <li class="mb-4"><strong>What are the rules for supplying a parts run?</strong>
                        <ul>
                            <p class="mb-3">The main rules are not taking money up front and keeping people updated and having a sign up list.</p>
                        </ul>
                    </li>
