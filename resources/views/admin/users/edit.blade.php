  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-row">
        ...
        <div class="col-md-1 mb-3">
          {!! html()->hidden('accepted_gdpr', '0') !!}
          <label>GDPR</label>
          <input type="checkbox" name="accepted_gdpr" {{ $user->accepted_gdpr ? 'checked=1 value=1' : 'value=1' }}
            class="form-control">
        </div>
        <div class="col-md-4 mb-3">
      ...
      <div class="form-row">
        ...
        <div class="col-md-4">
          @foreach($clubs as $club)
            <div class="form-check">
              <input type="checkbox" name="clubs[]" value="{{  $club->id }}" @if($user->isAdminOf($club)) checked @endif>
