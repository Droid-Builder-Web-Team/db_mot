    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="text-center db-mb-2">User Settings</h4>
            </div>
        </div>
        <form action="{{ route('settings.update', Auth::user()->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row build-section db-my-2 d-flex justify-content-center">
                <div class="col-12 text-center">
                    <h5 class="text-left db-mb-2">Email Notifications</h5>
                </div>
            ...
            <div class="row build-section db-my-2 d-flex justify-content-center">
                <div class="col-12 text-center">
                    <h5 class="text-left db-mb-2">Date Format</h5>
                </div>
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-sm table-hover table-dark text-center">
            ...
            <div class="row build-section db-my-2 d-flex justify-content-center">
                <div class="col-12 db-mb-2">
                    <h5 class="text-left">Event Requirements</h5>
                    <small class="form-text text-muted">Requirements for getting notifications about new events added</small>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm table-hover table-dark text-center">
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" name="max_event_distance" value="{{ $settings['max_event_distance'] }}">
                                </td>
                        </table>
                    </div>
                </div>
