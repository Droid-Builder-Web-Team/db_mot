        ...
        <div class="col-md-12">
            <div class="card">
                @foreach($partsRunData as $data)
                    ...
                    <div class="card-body">
                        {!! html()->form('PUT', route('parts-run.update', $data->id))->open() !!}
                        <div class="form-group row">
                            <div class="col-10">
                                ...
                                <div class="col-10">
                                    <select id="status" name="status" class="custom-select">
                                        ...
                                        <option {{ ($data->status) == 'Gathering_Interest' ? 'selected' : '' }}
                                            value="Gathering_Interest">Gathering Interest</option>
                                        <option {{ ($data->status) == 'Initial' ? 'selected' : '' }} value="Initial">Initial
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-1 mb-2">
                                ...
                                <input type="checkbox" name="open" {{ $data->open ? 'checked=1 value=1' : 'value=1' }}
                                    class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-12">
                                    <input type="text" name="title" value="{{ $data->partsRunAd->title }}" class="form-control"
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-12">
                                    <input type="number" step="0.01" name="price" value="{{ $data->partsRunAd->price }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-12">
                                    <input type="text" name="location" value="{{ $data->partsRunAd->location }}"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-12">
                                    <input type="number" step="0.01" name="shipping_costs"
                                        value="{{ $data->partsRunAd->shipping_costs }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-12">
                                    <textarea type="text" name="history" value="{{ $data->partsRunAd->history }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-4 col-12">
                                ...
                                <div class="col-12">
                                    <input size=5 type="number" name="quantity" value="{{ $data->partsRunAd->quantity }}"
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="col-12">
                                    <input size=5 type="number" name="reserve" value="{{ $data->partsRunAd->reserve }}"
                                        class="form-control" placeholder="Reserve" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="col-12">
                                    <input type="text" name="contact_email" value="{{ $data->partsRunAd->contact_email }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-12">
                                    <input type="text" name="purchase_url" value="{{ $data->partsRunAd->purchase_url }}"
                                        class="form-control">
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <select class="form-control" name="purchase_url_type">
                                        @foreach($data->partsRunAd->purchaseTypes() as $key => $value)
                                            <option value="{{ $key }}" @if($key == $data->partsRunAd->purchase_url_type) selected
                                            @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
